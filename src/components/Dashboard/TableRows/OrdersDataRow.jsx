  ...
  return (
    <tr>
      <td className="px-5 py-5 border-b border-gray-300  text-sm">
        <p className="font-semibold text-gray-500">{order?._id}</p>
      </td>
      <td className="px-5 py-5 border-b border-gray-300  text-sm">
        <p className="font-semibold text-gray-500">{order?.buyer?.name}</p>
      </td>
      <td className="px-5 py-5 border-b border-gray-300  text-sm">
        <p className="font-semibold text-gray-500">{order?.buyer?.email}</p>
      </td>
      <td className="px-5 py-5 border-b border-gray-300  text-sm">
        <p className="font-semibold text-gray-500">{order?.product.name}</p>
      </td>
